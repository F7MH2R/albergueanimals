...
@WebServlet("/VeterinarioAnimalsServlet")
public class VeterinarioAnimalsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (Connection conn = DatabaseConnection.initializeDatabase()) {
            ...
            // Redirigir directamente a la vista de veterinario
            request.getRequestDispatcher("/Empleado/Veterinario/animals.jsp").forward(request, response);
